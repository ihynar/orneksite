  ...
  <div className="container py-5">
    <div className="row align-items-center">
      ...
      <div className="col-md-6">
        ...
        <p className="lead">
          Yerinde buharlı yıkama, leke çıkarma ve antibakteriyel çözümlerle evlerinizi ve ofislerinizi
          hijyenle buluşturuyoruz. Eğitimli ekibimiz, kumaş dostu formüller ve yüksek ısı ile kalıcı temizlik
          sağlar.
        </p>
